...
Sanitizers use the same WASM infrastructure as validators and custom functions. See [WASM](../advanced/wasm.md) for memory management details, supported languages, and build instructions.
